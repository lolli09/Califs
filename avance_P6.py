...
while materia_2<0 or materia_2 >101:
    materia_2=int(input("Tu número fue incorrecto, ¿cuánto sacaste en la materia 2 del 1 al 100??"))
prom(materia_2)

    
materia_3=int(input("¿Cuánto sacaste en la materia 3 del 1 al 100?"))
while materia_3<0 or materia_3 >101:
    materia_3=int(input("Tu número fue incorrecto, ¿cuánto sacaste en la materia 3 del 1 al 100??"))
prom(materia_3)
...
while materia_4<0 or materia_4 >101:
    materia_4=int(input("Tu número fue incorrecto, ¿cuánto sacaste en la materia 4 del 1 al 100??"))
prom(materia_4)

    
materia_5=int(input("¿Cuánto sacaste en la materia 5 del 1 al 100?"))
while materia_5<0 or materia_5>101:
    materia_5=int(input("Tu número fue incorrecto, ¿cuánto sacaste en la materia 5 del 1 al 100??"))
prom(materia_5)

materia_6=int(input("¿Cuánto sacaste en la materia 6 del 1 al 100?"))
while materia_6<0 or materia_6>101:
    materia_6=int(input("Tu número fue incorrecto, ¿cuánto sacaste en la materia 6 del 1 al 100??"))
prom(materia_6)         
